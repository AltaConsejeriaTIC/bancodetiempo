@extends('emails.partial.layout')
    @section('title')
        ...
        <br>
        <h3>Ya haces parte de la campaña {{$campaign->name}}</h3>
    @endsection
    @section('content')
        ...
        <div style='background: #bbd9ea;
                    ...
                    margin:auto;
                    width: 50%;'>
            Ya haces parte de la campaña {{$campaign->name}}. Marca el día en tu calendario y prepárate para participar. ¡Muchas gracias por querer marcar la diferencia!
        </div>        
    @endsection
    @section('action')
