				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						{!! Form::open(['route' => 'admin/show', 'method' => 'post', 'novalidate', 'class' => 'form-inline']) !!}           
							...
							<a href="{{ route('admin.index') }}" class="btn btn-raised btn-primary">Todos</a>
							<a href="{{ route('admin.create') }}" class="btn btn-raised btn-success">Crear</a>
						{!! Form::close() !!}
						    ...
						    <tbody>
						      @foreach($users as $user)
						        <tr>
						        	...
						        	<td>{{ $user->role_id }}</td>
						        	<td>
						        		<a class="btn btn-raised btn-primary btn-xs" href="{{ route('admin.edit',['id' => $user->id] )}}" >Editar</a>        		
						        	</td>                 
						        </tr>
						      @endforeach
						    </tbody>         
