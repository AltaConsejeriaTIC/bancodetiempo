...
<div class="modal fade" id="modalNewService" tabindex="-1" role="dialog" >
            ...
            <div class="modal-wrapper">
                <div class="modal-container">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <select name='categoryService' class='col-xs-12  col-sm-12 categories validation' v-model='category'  data-validations='["required"]'>                                
                            </select> 
                        ...
                        <div class="row">    		
                           ...
                           <label for="imageService" class='text-center col-xs-12 col-sm-12' v-bind:class="" style=""><span>Sube una foto</span></label>
                        </div>
