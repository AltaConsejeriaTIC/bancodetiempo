			...
			<div class="modal-wrapper">
				<div class="modal-container">
					...
					<div class="modal-body">
						{!! Form::open(['url' => '/campaign-report/create/'.$campaign->id, 'method' => 'post', 'enctype' => 'multipart/form-data', 'id' => 'form', 'class' => 'form-custom col-xs-12 col-sm-12']) !!}
						<div class="row">
							<p class="modal-title titleContent text-center title1 ">Reportar contenido</p>
							<p class="modal-title titleContent text-center title4">Oferta: {{$campaign->name}}</p>
							<p class="modal-title titleContent text-center "><i class=" material-icons report_icon" aria-hidden="true">report</i>
							</div>
							<div class="row ">
								<div class="col-md-12" >
