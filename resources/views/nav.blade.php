	...
	<nav class='navbar navbar-default navbar-static-top nav1'>
		...
		<div class="container">
			<div class='row'>
				...
				@elseif((!Auth::guest()))
					<a class="hidden-xs col-sm-4 col-sm-offset-5 col-md-4 col-md-offset-5" href="{{ url('/logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">Cerrar Sesión</a>
