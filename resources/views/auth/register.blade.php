                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/register') }}">
						...
						<div class="avatar">
							...
							<input type="hidden" value="{{ $providerData['avatar'] }}">
                        ...
                        <div class="form-group{{ $errors->has('gender') ? ' has-error' : '' }}">
                         ...
                         <div class="form-group{{ $errors->has('birthdate') ? ' has-error' : '' }}">
                         	...
                         	<div class="col-md-6">               
                         		...
                         		<input type="datetime" id="birthdate" name="birthdate" class="form-control datepicker" value="{{ old('birthdate')}}{{  $providerData['birthday']  }}" />
