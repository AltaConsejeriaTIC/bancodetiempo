...
<section class='banner'>
	...
	<div class="container">
	   ...
	   <article class='row'>
			...
			<h3 class='col-md-12 col-sm-12 col-xs-10 col-xs-offset-1 white-text visible-xs'>- descrubre<br> - aprende<br> - enseña<br> - comparte</h3>	
			<h2 class='col-md-12 col-sm-12 text-center white-text hidden-xs'>descrubre - aprende - enseña - comparte</h2>	   
