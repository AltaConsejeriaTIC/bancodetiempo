...
<div style="width:512px;position:relative;margin:auto">
    ...
    <section style='width:90%;position:relative;margin:auto;'>
        <article>
            ...
            <p style='color:#000;font-family: "Open Sans", sans-serif;'>Lamentamos informarte que tu
                campaña {{$campaign->name}} <strong>no cumple con los <a href="http://cambalachea.co/content/terms">términos
                        y condiciones</a> de la plataforma, por lo que tuvimos que deshabilitarla.</strong> Si tienes
                alguna duda escríbenos al correo
                <a href="mailto:info@cambalachea.co">info@cambalachea.co</a>
            </p>
        </article>
