                ...
                <div class="modal-wrapper">
                    <div class="modal-container">
                        <div class="modal-header">
                            <button type="button" class="close circle-shape" data-dismiss="modal" aria-label="Close">
                            ...
                            <div class='newServiceForm'>
                                ...
                                <div class="row">
                                    <input type="text" name="serviceName" autofocus
                                           ...
                                           class="col-xs-12 col-sm-12 col-md-12 validation" v-model="serviceName"
                                           maxlength="50" data-validations='["required", "min:3", "max:50"]'>
                                    <i for='serviceName'></i>
                                    <div class="msg" errors='serviceName'>
                                        <p error='required'>Este campo es obligatorio.</p>
                                        <p error='min'>Este campo debe ser mínimo de 3 caracteres.</p>
                                ...
                                <div class="row">
                                    <textarea class="countCharacters col-xs-12 col-sm-12 col-md-12 validation" rows="8"
                                              name="descriptionService" id='descriptionService'
                                ...
                                <div class="row">
                                    <div class="col-xs-6 col-sm-6 not-padding ">
                                        <input type="checkbox" name="modalityServiceVirtually" value="1"
                                               id="modalityServiceVirtually" class="square validation"
                                               v-model="modalityServiceVirtually"
                                               data-validations='["requiredIfNot:modalityServicePresently"]'>
                                        <label for="modalityServiceVirtually">Virtual</label>
                                    </div>
                                    <div class="col-xs-6 col-sm-6 not-padding ">
                                        <input type="checkbox" name="modalityServicePresently" value="1"
                                               id="modalityServicePresently" class="square validation"
                                               v-model="modalityServicePresently"
                                ...
                                <div class="row">
                                    <div class="col-xs-6 col-sm-6">
                                        <input type="radio" name="valueService" value="1" id="time1"
                                               class="circle validation" data-validations='["requiredRadio"]'>
                                        <label for="time1">1 Hora</label>
                                    </div>
                                    <div class="col-xs-6 col-sm-6">
                                        <input type="radio" name="valueService" value="2" id="time2"
                                               class="circle validation" data-validations='["requiredRadio"]'>
                                        <label for="time2">2 Horas</label>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-xs-6 col-sm-6">
                                        <input type="radio" name="valueService" value="3" id="time3"
                                               class="circle validation" data-validations='["requiredRadio"]'>
                                        <label for="time3">3 Horas</label>
                                    </div>
                                    <div class="col-xs-6 col-sm-6">
                                        <input type="radio" name="valueService" value="4" id="time4"
                                               class="circle validation" data-validations='["requiredRadio"]'>
                                        <label for="time4">4 Horas</label>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <select name='categoryService' class='col-xs-12  col-sm-12 validation'
                                            v-model='category' data-validations='["required"]'>
                                        <option value="">Seleccione una Categoría....</option>
                                        <option v-for="op in this.categories" :value="op.id">{{op.category}}</option>
                                    </select>
                                    <div class="msg" errors='categoryService'>
                                ...
                                <div class="row">
                                    <label for="tagService" class="paragraph10">Palabras clave</label><span
                                        class="text-opacity"> (Opcional)</span>
                                </div>
                                <div class="row">
                                    <input-tag class="col-xs-12  col-sm-12 no-input" :on-change="setTags"
                                               placeholder="Ej. EstiloDeVida JuegosDeMesa Collar" validate="text"
                                               :tags="tags"></input-tag>
                                    <input type="hidden" name="tagService" v-model="tagService">
                                </div>
                                <div class="row">
                                    <label for="imageService" class="paragraph10">Foto de la oferta</label><span
                                        class="text-opacity"> (Opcional)</span>
                                </div>
                                <div class="row">
                                    <input type="file" name="imageService"
                                           class="boxPhoto1 col-xs-12 col-sm-12 col-md-12 validation" id='imageService'
                                           @change='previewPhotoService' data-validations='["maxFile:2500000"]'>
                                    <label for="imageService" class='text-center col-xs-12 col-sm-12'
                                           v-bind:class="{'text-white' : imageService!='', 'load' : imageService!=''}"
                                           :style="{ backgroundImage: 'url(' + imageService + ')' }"><span>Sube una foto</span></label>
